...
#
# This file is a part of < https://github.com/rogerpq/RepthonAr/ >
# PLease read the GNU Affero General Public License in
# <https://github.com/rogerpq/RepthonAr/blob/master/LICENSE>.
...
class Var:
    ...
    STRING_SESSION = (
        sys.argv[3] if len(sys.argv) > 3 else config("SESSION", default=None)
    )
    REDIS_URI = (
        sys.argv[4]
        if len(sys.argv) > 4
    ...
    # extras
    TG_BOT_TOKEN = config("BOT_TOKEN", default=None)
