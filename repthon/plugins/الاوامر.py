...
async def hi(event):
    await edit_or_reply(
        event,
        "**[ . 𝐑𝐄𝐏𝐓𝐇𝐎𝐍𓌶 - 𝐂𝐌𝐃- .](t.me/Repthon)**\n 𓅔 ━━━━━ ━━—×—━━ ━━━━━ 𓅔**\n\n** - آهـلاً وسـهلاً بك فـي قائـمة أوامـر السـورس ⇣⇣⇣\n\n`.م1` ⇦لأوامـر الأدمـن\n`.م2` ⇦لأوامـر المجـموعة\n`.م3` ⇦لأوامـر الترحـيب\n`.م4` ⇦لأوامـر الردود\n`.م5` ⇦لأوامـر الترفـيه\n`.م6` ⇦لأوامـر حـماية الخـاص\n`.م7` ⇦لأوامـر الاذاعـة والكـشف\n`.م8` ⇦لأوامـر البـوت\n`.م9` ⇦لأوامـر المـنع والترجـمة\n`.م10` ⇦لأوامـر التـلكراف والنـطق\n`.م11` ⇦لأوامـر التحـميل\n`.م12` ⇦لأوامـر التـكرار\n`.م13` ⇦لأوامـر الانتـحال والتـقليد\n`.م14` ⇦لأوامـر الوقـتي\n`.م15` ⇦لأوامـر الذاتـيه والاضـافة\n`.م16` ⇦لأوامـر البـروفايل\n`.م17` ⇦لأوامـر الأكسـترا\n`.م18` ⇦للتـاك والملـفات\n`.م19` ⇦لأوامـر الصيـغ\n`.م20` ⇦لأوامـر التسـلية\n`.م21` ⇦لأوامـر التـحكم\n`.م22` ⇦لأوامـر حـماية المجـموعة",
        link_preview=False,
    )
