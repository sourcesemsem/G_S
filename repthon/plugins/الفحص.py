...
from repthon import StartTime, jmthonversion, sbb_b
...
async def amireallyalive(event):
    ...
    start = datetime.now()
    jmthonevent = await edit_or_reply(event, "** ᯽︙ يتـم التـأكـد انتـظر قليلا رجاءا**")
    end = datetime.now()
...
def jmthonalive_text():
    ...
    jmthon_caption += f"**{EMOJI} اصدار ريبثون :** `{jmthonversion}`\n"
...
ROZ_PIC = "https://telegra.ph/file/d46cf95b14919ea51578f.jpg"
RAZAN = Config.TG_BOT_USERNAME
ROZ_T = (
    f"**⌯︙بوت ريبثون يعمل بنجاح 🤍،**\n"
    f"**   - اصدار التليثون :** `1.23.0\n`"
    f"**   - اصدار ريبثون :** `4.0.0`\n"
        ...
        if query.startswith("السورس") and event.query.user_id == sbb_b.uid:
            buttons = [
                [
                    ...
                    Button.url("المطـور 👨🏼‍💻", "https://t.me/E_7_V"),
                ]
            ]
